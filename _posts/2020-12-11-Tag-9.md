...
<img alt="Schaubild" src="https://github.com/stemorit/BAIN-Lerntagebuch/blob/master/_posts/img012-Schaubild-OpenRefine.png?raw=true" width="80%"/>
...
Die Dozierenden haben die Datensätze von Koha, DSPACE, ArchiveSpace und DOAJ für diejenigen, bei denen bis jetzt nicht alle Übungen reibungslos funktioniert haben bereitgestellt. Anscheinend wurden da von den Dozierenden extra (?) noch Fehler eingebaut. So macht es die Übung natürlich viel mühsamer, aber auch lehrreicher und für die Interessierten auch spannender. Bei der Importierung der Datensätzen aus Koha schien alles reibungslos funktioniert zu haben, aber bei den Datensätzen aus ArchivesSpace und DSpace gab es Probleme. So hat Gruppe 1 und 3 aus der Gruppenarbeit herausgefunden, dass die "ID" fehlt. 
