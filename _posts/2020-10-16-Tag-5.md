...
Bei Lektion 8 gab es noch ein Feedback zu genau dem fettgedruckten Satz oben (Der Import und Export ist nie verlustfrei und EAD ist nicht perfekt. Auch sind saubere XML-Daten eher eine Illusion.) von Herr Lohmeier.
* *Für die Prüfung, ob XML-Dateien “sauber” sind, kann ein Schema für das Datenformat verwendet werden, das zumindest die Form prüft. So wie wir es heute für die mit OpenRefine generierten MARCXML-Daten machen werden.*
* *Verlustfreie Konvertierung ist möglich, wenn das Zielformat mehr Möglichkeiten bietet als das Ausgangsformat, also z.B. von DC zu MARC21.*
